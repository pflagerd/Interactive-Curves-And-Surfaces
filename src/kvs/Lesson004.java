...
public class Lesson004 extends glut {
	...
	void DrawCurve(Double PointSize) {
		...
		for (double i = 0; i <= 100; i++) {
			double[] XY = EvaluateCurveEquationForY(i/100,80);
	...
	private double[] EvaluateCurveEquationForY(double t, double circleRadious) {
		return (new double[] {circleRadious * ((2 * t)/(1 + (t*t))) ,(circleRadious * (1 - (t*t))/(1 + (t*t)))} );
	}
	...
	public static void main(String[] args) {
		...
		new Lesson004().main(args.length, args);
	}
