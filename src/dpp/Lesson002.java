...
public class Lesson002 extends glut {
	...
	void drawCircle(double radius, int increments, int color) {
		...
		for (int i = 0; i < increments; i++) {
			...
			double x = -radius + i * 2 * radius / increments; // go from 0.5 <= x < 0.5
...
//		}
	...
	public static void main(String[] args) {
		new Lesson002().main(args.length, args);
	}
}
